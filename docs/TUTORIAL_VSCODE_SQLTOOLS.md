...
| Port | `15445` | El puerto del host del compose (`15445:1433`) |
...
> El puerto es la clave: **15445, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15445
...
>
> ```
> Error opening connection Failed to connect to localhost:15445
...
> (`http://localhost:8045/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15445) con test y guardarla |
