...
| **v4** | Segundo motor (**SQL Server**): la MISMA bdfacturas en dialecto T-SQL, los 11 repositorios SqlClient, la **fábrica de repositorios** (el motor se decide en UN punto), el interruptor `MOTOR_BD` y el contenedor **sqlserver-init** (la lección prometida en v1) — cero endpoints nuevos | **En curso** ([spec](v4_sqlserver/2_spec.md)) |
